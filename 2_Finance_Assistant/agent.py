...
Type hints - principal: float, years: int - tell the LLM what types to use
Clear parameter names - annual_rate not just rate
Defaults for optional params - compounds_per_year: int = 12
Comprehensive docstring - explain WHAT the function does and WHEN to use it
"""
